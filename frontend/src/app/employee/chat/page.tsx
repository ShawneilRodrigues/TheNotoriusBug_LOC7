...
export default function EmployeeChat() {
    ...
    return (
        <div className="flex h-screen bg-background">
            ...
            <aside
                className={cn(
                    'absolute inset-y-0 left-0 z-50 w-64 bg-card transform transition-transform duration-200 ease-in-out pt-12 bg-gray-200 dark:bg-gray-700',
            ...
            >
                ...
                <footer className="border-t bg-background p-4">
                    ...
                    >
                        <div className="flex items-end space-x-2 bg-card rounded-lg p-2">
                            <Button
                                type="button"
                                variant="ghost"
                                size="icon"
