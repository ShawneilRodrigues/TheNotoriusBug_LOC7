...
export default function HowItWorksSection() {
    ...
    return (
        <section className="md:flex flex-col items-center justify-center p-4 min-h-screen bg-black">
                ...
                {[
                    {
                        ...
                        description:
                            'Securely upload company policies and documents',
                    },
                    {
                        title: 'AI Trains',
                        description:
                            'Our AI processes and learns from your data',
                    },
                    {
